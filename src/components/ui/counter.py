...
class Counter:
  def __init__(self):
    ...
    self.fab_inc = ft.FloatingActionButton(icon=ft.Icons.ADD, on_click=self.increment)
    self.fab_dec = ft.FloatingActionButton(icon=ft.Icons.REMOVE, on_click=self.decrement)
